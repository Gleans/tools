...
package store.zabbix.gateway.filter;
...
import store.zabbix.common.core.exception.ValidateCodeException;
import store.zabbix.common.core.util.ResultBean;
import store.zabbix.common.core.util.WebUtils;
				...
				try {
					return response.writeWith(Mono.just(response.bufferFactory()
						.wrap(objectMapper.writeValueAsBytes(
								ResultBean.builder().msg(e.getMessage())
