...
package store.zabbix.auth.api.feign.fallback;
...
public class RemoteTokenServiceFallbackImpl implements RemoteTokenService {
	 ...
	 */
	@Override
	public ResultBean getTokenPage(Map<String, Object> params, String from) {
	 ...
	 */
	@Override
	public ResultBean<Boolean> removeToken(String s, String id) {
