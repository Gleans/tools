...
import store.zabbix.auth.api.feign.RemoteUserService;
...
@Service
@NoArgsConstructor
public class ToolsUserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		ResultBean<UserInfo> result = remoteUserService.info(username, SecurityConstants.FROM_IN);
	 ...
	 * @return
	 */
	private UserDetails getUserDetails(ResultBean<UserInfo> result) {
